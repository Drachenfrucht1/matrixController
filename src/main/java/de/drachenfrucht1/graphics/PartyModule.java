...
public class PartyModule {
    ...
    //ui elements
    private final CheckBox blackC;
    private final CheckBox mixC;
    private final Slider redS;
    private final Slider greenS;
    private final Slider blueS;
    private final TextField fadeT;
